odoo.define("delivery_canada_post.checkout", function (require) {
  ...
  publicWidget.registry.websiteSaleDelivery = publicWidget.Widget.extend({
    ...
    start: function () {
      ...
      if (showhideink) {
        showhideink.src =
          "/delivery_canada_post/static/src/images/ln-plus.png.png";
      }
      ...
      if (result.status === true) {
        ...
        function popoulate_table(datas) {
          var tableRef = document
            .getElementById("cn_estimate_table")
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="border-bottom: solid 1px white; width: 50px; white-space: nowrap;"
                                                        ...
                                                        <span
                                                            id="lblBaseCostValue"
                                                            class="StaticText">$${rec.base_price.toFixed(
                                                              2
                                                            )}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="border-bottom: solid 1px white; width: 50px; white-space: nowrap;"
                                                        ...
                                                        <span
                                                            id="lblCostValue"
                                                            class="StaticText">$${rec.surcharges.toFixed(
                                                              2
                                                            )}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="border-bottom: solid 1px white; width: 50px; white-space: nowrap;"
                                                        ...
                                                        <span
                                                            id="lblCostValue"
                                                            class="StaticText">$${rec.taxes.toFixed(
                                                              2
                                                            )}</span>
                                                    </td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="border-bottom: solid 1px white; width: 50px; white-space: nowrap; vertical-align: bottom;"
                                                        ...
                                                        <span
                                                            id="txtGrandTotal1"
                                                            class="StaticText">${rec.total_price.toFixed(
                                                              2
                                                            )}</span>
                                                    </td>
                                                    <td style="border-bottom: solid 1px white; width: 75px; white-space: nowrap;"
    ...
    _onshowHideLink: function (ev) {
      ...
      if (src[src.length - 1] == "ln-plus.png") {
        ev.currentTarget.firstElementChild.src =
          "/delivery_canada_post/static/src/images/ln-minus.png";
        ...
        ev.currentTarget.firstElementChild.src =
          "/delivery_canada_post/static/src/images/ln-plus.png";
        ev.currentTarget.parentElement.parentElement.parentElement.children[2].children[0].firstElementChild.style.display =
          "none";
      }
    },
